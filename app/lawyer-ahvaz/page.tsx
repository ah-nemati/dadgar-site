...
export const metadata: Metadata = {
  title: "وکیل پایه یک دادگستری در  ",
  description:
    "خدمات حضوری  ، وکیل پایه یک دادگستری و عضو کانون وکلای خوزستان، در   برای دعاوی حقوقی، کیفری، خانواده، املاک و سایر حوزه‌ها.",
...
export default async function LawyerAhvazPage() {
  ...
  const breadcrumb = breadcrumbJsonLd(
    [
      { name: "خانه", path: "/" },
      { name: "وکیل در  ", path: "/lawyer-ahvaz" },
    ],
    firm.url,
  );
  ...
  return (
    <>
      ...
      <PageHero
        eyebrow="خدمات حضوری  "
        title="وکیل پایه یک دادگستری در  "
        description="برای مشاوره، بررسی اسناد و هماهنگی پیگیری پرونده می‌توانید پس از تعیین وقت به دفتر مراجعه کنید."
      />
      ...
      <section className="editorial-section">
        <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[.78fr_1.22fr] lg:items-start">
          <aside className="lawyer-feature overflow-hidden lg:sticky lg:top-28">
            <div className="relative h-72">
              ...
              <div className="absolute inset-x-0 bottom-0 p-6">
                <p className="text-2xl font-extrabold text-parchment"> </p>
                <p className="mt-1 text-sm text-parchment/65">
                  وکیل پایه یک دادگستری
                </p>
                <span className="mt-3 inline-flex rounded-full border border-white/15 bg-black/15 px-3 py-1 text-xs font-bold text-gold-light">
                  پروانه ۲۳۰۶
                </span>
              </div>
            </div>
            <div className="relative z-10 p-6">
              <div className="space-y-4 text-sm leading-7 text-sky-800/70">
                <div className="flex items-start gap-3">
                  <MapPin className="mt-1 shrink-0 text-gold-light" size={18} />
                  <span>{firm.address}</span>
                </div>
                <div className="flex items-center gap-3">
                  <Clock className="shrink-0 text-gold-light" size={18} />
                  <span>{firm.hours}</span>
                </div>
                <div className="flex items-center gap-3">
                  <Phone className="shrink-0 text-gold-light" size={18} />
                  <a
                    href={firm.phoneHref}
                    dir="ltr"
          ...
          <div>
            <Eyebrow>دفتر </Eyebrow>
            <h2 className="section-title">
              مراجعه حضوری وقتی ارزشمند است که جلسه از قبل آماده باشد
            </h2>
            <p className="section-copy">
              پیش از جلسه می‌توانید نوع مسئله و مدارک اصلی را اعلام کنید تا مشخص
              شود چه اسنادی همراه داشته باشید و آیا بررسی اولیه آنلاین کافی است
              یا حضور در دفتر مناسب‌تر خواهد بود.
            </p>
            <p className="mt-5 text-sm leading-8 text-muted-foreground">
              دفتر در حوزه‌های حقوقی، کیفری، خانواده، املاک، قرارداد، ارث،
              مطالبات، امور ثبتی و حقوق کار خدمات ارائه می‌دهد. هر پرونده بر
              اساس اسناد و شرایط خودش بررسی می‌شود و نتیجه هیچ پرونده‌ای قابل
              تضمین نیست.
            </p>
            ...
            <div className="mt-9 grid gap-4 sm:grid-cols-2">
              {practiceAreas.map((area) => {
                ...
                return (
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <span className="legal-card__icon size-10">
                        <AreaIcon size={18} />
                      </span>
                      <div>
                        <h3 className="font-extrabold text-foreground group-hover:text-accent">
                          {area.title}
                        </h3>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Button asChild>
                <Link href="/online-legal-consultation">
                  صحبت با وکیل <ArrowLeft size={16} />
                </Link>
              </Button>
              <Button variant="outline" asChild>
                <Link href="/fees">نحوه تعیین تعرفه</Link>
              </Button>
              <Button variant="outline" asChild>
                <Link href="/lawyers/majid-savari">
                  <Award size={16} /> سوابق وکیل
                </Link>
              </Button>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="mb-6">
            ...
            <h2 className="text-2xl font-extrabold text-foreground md:text-3xl">
              آدرس دفتر وکیل در روی نقشه
            </h2>
            <p className="mt-2 text-sm leading-7 text-muted-foreground">
              نشانگر، موقعیت دفتر را مشخص می‌کند. برای بازکردن مسیر در Google
              Maps از دکمه مسیریابی استفاده کنید.
            </p>
          </div>
          <OfficeMap firm={firm} />
        </div>
