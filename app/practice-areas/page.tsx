...
export const metadata: Metadata = {
  ...
  description:
    "خدمات حقوقی   در دعاوی املاک، چک، خانواده، کیفری، قرارداد، ارث، مطالبات، ثبت و حقوق کار؛ آنلاین سراسر ایران و حضوری  .",
};
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="section-kicker">
            ...
            <p className="section-copy">
              اگر مطمئن نیستید موضوع شما در کدام حوزه قرار می‌گیرد، از بخش
              مشاوره آنلاین شرح کوتاهی از مسئله ثبت کنید.
            </p>
          </div>
            ...
            {practiceAreas.map((area, index) => {
              ...
              return (
                <Link
                  ...
                  className="legal-card group p-6 md:p-7"
                >
        ...
        <div className="mx-auto grid max-w-7xl gap-5 px-4 sm:px-6 lg:grid-cols-2">
          <div className="legal-card p-5 sm:p-7 md:p-8">
            ...
            <h2 className="mt-6 text-2xl font-extrabold text-foreground">
              مشاوره آنلاین برای سراسر ایران
            </h2>
            <p className="mt-3 max-w-xl text-sm leading-8 text-muted-foreground">
              موضوع و مدارک اصلی را بدون مراجعه حضوری در حساب خصوصی ارسال کنید و
              در همان مسیر پاسخ را پیگیری کنید.
            </p>
            <Button className="mt-6" asChild>
              <Link href="/online-legal-consultation">
                نحوه دریافت مشاوره <ArrowLeft size={15} />
              </Link>
            </Button>
          </div>
          <div className="legal-card p-5 sm:p-7 md:p-8">
            ...
            <p className="mt-3 max-w-xl text-sm leading-8 text-muted-foreground">
              برای بررسی اصل اسناد، جلسه حضوری یا هماهنگی قبول وکالت می‌توانید
              موقعیت دفتر و نحوه مراجعه را ببینید.
            </p>
            <Button className="mt-6" variant="outline" asChild>
              <Link href="/lawyer-ahvaz">
                آدرس و اطلاعات دفتر <ArrowLeft size={15} />
              </Link>
            </Button>
          </div>
        </div>
