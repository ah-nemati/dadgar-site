...
export async function generateMetadata({
  ...
  return {
    ...
    description:
      area.seoDescription ||
      `${area.shortDesc} مشاوره غیرحضوری برای سراسر ایران و خدمات حضوری در اهواز.`,
      ...
      <section className="bg-ink relative overflow-hidden">
        <div className="max-w-6xl mx-auto px-6 py-14 relative">
          ...
          <div className="flex items-center gap-4 mb-5">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-parchment">
              {area.title}
            </h1>
          </div>
          <p className="text-parchment/80 max-w-2xl leading-8">
            {area.shortDesc}
          </p>
        </div>
      </section>
              ...
              {area.topics.map((topic, i) => (
                <div key={i} className="flex items-start gap-3">
                  <CheckCircle2
                    ...
                    aria-hidden="true"
                  />
                  <span className="text-sm text-foreground leading-7">
                    {topic}
                  </span>
                </div>
              ))}
            ...
            <div className="mt-5 grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              >
                ...
                <span className="mt-2 block text-sm leading-7 text-muted-foreground">
                  بررسی اولیه موضوع و مدارک بدون مراجعه به اهواز
                </span>
              </Link>
              <Link
                href="/lawyer-ahvaz"
              ...
              >
                <span className="font-bold text-foreground">
                  مراجعه حضوری در اهواز
                </span>
                <span className="mt-2 block text-sm leading-7 text-muted-foreground">
                  بررسی حضوری اسناد و هماهنگی برای قبول وکالت
                </span>
              </Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="bg-ink rounded-sm p-6 text-center">
              <p className="text-parchment/85 text-sm mb-5">
                برای مشاوره در حوزه {area.title} با ما در تماس باشید.
              </p>
              ...
              <Link
                href="/fees"
                className="mt-4 block text-sm font-semibold text-gold-light hover:text-gold"
              >
