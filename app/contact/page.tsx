...
export const metadata: Metadata = {
  ...
  title: "تماس با ما",
  description:
    "ارسال درخواست بررسی حقوقی برای مشاوره آنلاین سراسر ایران یا مراجعه حضوری به دفتر   در  ؛ فرم تماس، تلفن و نشانی دفتر.",
  keywords: [
    "تماس با وکیل  ",
    "مشاوره حقوقی آنلاین",
    "مشاوره حقوقی  ",
...
export default async function ContactPage() {
  ...
  return (
    <>
      <PageHero
        eyebrow="تماس با دفتر"
        title="موضوع را توضیح دهید؛ مسیر ارتباط را انتخاب کنید"
        description="برای بررسی اولیه می‌توانید فرم را تکمیل کنید، مستقیم تماس بگیرید یا برای مراجعه حضوری موقعیت دفتر را روی نقشه ببینید."
      />
          ...
          <div className="grid gap-10 lg:grid-cols-[1.25fr_.75fr] lg:items-start">
            <div>
              <div className="mb-7">
                ...
                <h2 className="text-2xl font-extrabold text-foreground md:text-3xl">
                  شرح کوتاهی از مسئله ثبت کنید
                </h2>
                <p className="mt-3 text-sm leading-7 text-muted-foreground">
                  این فرم برای تماس اولیه است. برای ارسال مدارک پرونده از بخش
                  «صحبت با وکیل» در حساب کاربری استفاده کنید.
                </p>
              </div>
            ...
            <aside className="space-y-4 lg:sticky lg:top-28">
                      ...
                      <div className="min-w-0">
                        ...
                        {href ? (
                          <a
                            href={href}
                            dir={dir}
                            className="mt-1 block break-all text-sm font-extrabold text-foreground hover:text-accent"
                          >
                            {value}
                          </a>
                        ) : (
              ...
              <div className="rounded-2xl border border-sky-200 bg-sky-50 p-6 text-sky-900 shadow-sm">
                ...
                <p className="mt-4 text-xs leading-6 text-sky-700/60">
                  پیش از مراجعه، برای زمان جلسه و مدارک مورد نیاز هماهنگ کنید.
                </p>
              </div>
            </aside>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="mb-6">
            ...
            <p className="mt-2 text-sm leading-7 text-muted-foreground">
              نشانگر روی نقشه محل دفتر را مشخص می‌کند و از دکمه مسیریابی
              می‌توانید مسیر را در Google Maps باز کنید.
            </p>
          </div>
          <OfficeMap firm={firm} />
        </div>
