  ...
  return (
    <section className="bg-parchment min-h-[72vh] flex items-center">
      <div className="max-w-md mx-auto px-6 py-16 w-full text-center">
        ...
        <p className="text-muted-foreground leading-8 mb-7">ثبت‌نام در صفحه امن Auth0 انجام می‌شود و پس از ورود، پروفایل پنل به‌صورت خودکار ساخته خواهد شد.</p>
        <Button asChild className="w-full"><a href="/auth/login?screen_hint=signup&returnTo=/account"><UserPlus size={17} /> ادامه ثبت‌نام امن</a></Button>
      </div>
    </section>
  );
}
