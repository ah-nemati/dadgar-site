            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-parchment/50">
                  دفتر خدمات حقوقی و وکالت
                </p>
              </div>
            </div>
            <p className="mt-5 max-w-sm text-sm leading-8 text-parchment/65">
              {firm.tagline}
            </p>
            <p className="mt-5 max-w-sm border-r border-gold/35 pr-4 text-xs leading-7 text-parchment/50">
              محتوای سایت برای آگاهی عمومی است و جایگزین بررسی اختصاصی اسناد و
              شرایط هر پرونده نیست.
            </p>
          </div>

          <div>
            <h2 className="mb-5 text-sm font-extrabold text-parchment">
              دسترسی سریع
            </h2>
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <Link href="/lawyer-ahvaz" className="site-footer__link">
                  وکیل در{" "}
                </Link>
              </li>
              <li>
                <Link href="/fees" className="site-footer__link">
                  تعرفه خدمات
                </Link>
              </li>
              <li>
            ...
            <ul className="space-y-4 text-sm text-parchment/65">
              <li className="flex items-start gap-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="site-footer__link leading-7"
                >
                  {firm.address}
                </a>
              </li>
