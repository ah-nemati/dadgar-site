...
پروژه‌ی Next.js 16 و React 19 برای وب‌سایت و پنل دفتر حقوقی مجید سواری است. احراز هویت، نشست‌ها و مدیریت کاربران به‌صورت داخلی روی PostgreSQL فعلی پروژه انجام می‌شود و هیچ سرویس احراز هویت بیرونی در مسیر ثبت‌نام یا ورود وجود ندارد.
